...
// detectMTU determines the optimal MTU for the WireGuard interface
// by reading the MTU of the underlay interface and subtracting the WireGuard overhead.
// If the underlay interface cannot be determined, it falls back to the default interface.
